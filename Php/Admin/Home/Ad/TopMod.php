...
<head>
    ...
    <meta name="description" content="YUTUCMS 修改头部横幅广告">
...
<body>
    ...
    <div class="main-content">
        ...
        <!-- 页面标题 -->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> 修改头部横幅广告
        </h1>
        <p class="page-subtitle">编辑广告信息和设置</p>
            ...
            <div class="card-body">
                <form method="post" class="settings-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="TopId" value="<?php echo $TopId;?>" placeholder="请输入广告排序编号">
                        <div class="form-hint">数字越小排序越靠前</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告链接URL</label>
                        <input type="text" class="form-control" name="TopWebUrl" value="<?php echo $TopWebUrl;?>" placeholder="请输入广告跳转链接">
                        <div class="form-hint">用户点击广告后跳转的目标网址</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告图片URL</label>
                        <input type="text" class="form-control" name="TopPicUrl" value="<?php echo $TopPicUrl;?>" placeholder="请输入广告图片链接">
                        <div class="form-hint">广告展示的图片地址</div>
                        
                        <!-- 图片预览 -->
                        <div class="image-preview">
                            <?php if($TopPicUrl): ?>
                                <img src="<?php echo $TopPicUrl; ?>" alt="广告图片预览" onerror="this.style.display='none'">
                                <div style="margin-top: 10px;">
                                    <a href="<?php echo $TopPicUrl; ?>" target="_blank" class="btn btn-outline" style="padding: 6px 12px;">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            ...
                            <input type="text" class="form-control" name="TopPicUrlWidth" value="<?php echo $TopPicUrlWidth;?>" placeholder="例如: 100% 或 300px">
                            <div class="form-hint">支持百分比和px格式，100%代表自适应宽度</div>
                        </div>
                        <div class="form-col">
                            <label class="form-label">广告图片高度</label>
                            <input type="text" class="form-control" name="TopPicUrlHeight" value="<?php echo $TopPicUrlHeight;?>" placeholder="例如: 100px">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="TopState" value="<?php echo $TopState;?>" placeholder="例如: 20241231">
                        <div class="form-hint">格式：YYYYMMDD，如20241231代表2024年12月31日</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告费/联系方式</label>
                        <input type="text" class="form-control" name="TopRemarks" value="<?php echo $TopRemarks;?>" placeholder="例如: 1000元，邮箱：123@qq.com">
    ...
    $(document).ready(function() {
        ...
        $('input[name="TopPicUrl"]').on('input', function() {
            ...
            var previewContainer = $(this).next('.image-preview');
        ...
        $('form').submit(function() {
            var requiredFields = ['TopId', 'TopWebUrl', 'TopPicUrl', 'TopPicUrlWidth', 'TopPicUrlHeight', 'TopRemarks', 'TopState'];
            var isValid = true;
            var errorMessage = '';
