...
<head>
    ...
    <title>修改浮漂广告 - YUTUCMS管理中心</title>
    <meta name="description" content="YUTUCMS 修改手机底部浮漂广告">
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb">
            ...
            <a href="#">广告设置</a>
            <span class="separator">/</span>
            <a href="?Php=Home/Ad/Float">手机底部浮漂广告</a>
            <span class="separator">/</span>
        ...
        <!-- 页面标题 -->
        <h1 class="page-title">
            <i class="fa fa-edit"></i> 修改手机浮漂广告
            <span class="mobile-badge">移动端专用</span>
        </h1>
        <p class="page-subtitle">编辑手机端底部悬浮广告信息和设置</p>
            ...
            <div class="card-body">
                <form method="post" class="settings-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="FloatName" readonly value="<?php echo $FloatName;?>" placeholder="广告位置">
                        <div class="form-hint">广告位置为固定值，不可修改</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告链接URL</label>
                        <input type="text" class="form-control" name="FloatWebUrl" value="<?php echo $FloatWebUrl;?>" placeholder="请输入广告跳转链接">
                        <div class="form-hint">用户点击广告后跳转的目标网址</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告图片URL</label>
                        <input type="text" class="form-control" name="FloatPicUrl" value="<?php echo $FloatPicUrl;?>" placeholder="请输入广告图片链接">
                        <div class="form-hint">浮漂广告展示的图片地址，建议使用适合移动端的图片</div>
                        
                        <!-- 图片预览 -->
                        <div class="image-preview">
                            <?php if($FloatPicUrl): ?>
                                <img src="<?php echo $FloatPicUrl; ?>" alt="广告图片预览" onerror="this.style.display='none'">
                                <div style="margin-top: 10px;">
                                    <a href="<?php echo $FloatPicUrl; ?>" target="_blank" class="btn btn-outline" style="padding: 6px 12px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="FloatState" value="<?php echo $FloatState;?>" placeholder="例如: 20241231">
                        <div class="form-hint">格式：YYYYMMDD，如20241231代表2024年12月31日</div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">广告费/联系方式</label>
                        <input type="text" class="form-control" name="FloatRemarks" value="<?php echo $FloatRemarks;?>" placeholder="例如: 1000元，QQ：123456">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="?Php=Home/Ad/Float" class="btn btn-outline">
    ...
    $(document).ready(function() {
        ...
        // 实时图片预览
        $('input[name="FloatPicUrl"]').on('input', function() {
        ...
        $('form').submit(function() {
            var requiredFields = ['FloatWebUrl', 'FloatPicUrl', 'FloatRemarks', 'FloatState'];
            var isValid = true;
            var errorMessage = '';
    ...
    if (isset($_POST['submit']) && isset($_POST['Id']) && isset($_POST['FloatName']) && isset($_POST['FloatWebUrl']) && isset($_POST['FloatRemarks']) && isset($_POST['FloatPicUrl']) && isset($_POST['FloatState'])) {
        ...
        $FloatName = post_input($_POST["FloatName"]);
        $FloatWebUrl = post_input($_POST["FloatWebUrl"]);
        $FloatRemarks = post_input($_POST["FloatRemarks"]);
        $FloatPicUrl = post_input($_POST["FloatPicUrl"]);
        $FloatState = post_input($_POST["FloatState"]);
